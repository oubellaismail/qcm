...
public class CorrectAnswers {
    ...
    public CorrectAnswers(int id, boolean answer_a_correct, boolean answer_b_correct, boolean answer_c_correct, boolean answer_d_correct, boolean answer_e_correct, boolean answer_f_correct) {
        this.id = id;
        this.answer_a_correct = answer_a_correct;
        this.answer_b_correct = answer_b_correct;
        this.answer_c_correct = answer_c_correct;
    ...
    public CorrectAnswers id(int id) {
        setId(id);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return id == correctAnswers.id && answer_a_correct == correctAnswers.answer_a_correct && answer_b_correct == correctAnswers.answer_b_correct && answer_c_correct == correctAnswers.answer_c_correct && answer_d_correct == correctAnswers.answer_d_correct && answer_e_correct == correctAnswers.answer_e_correct && answer_f_correct == correctAnswers.answer_f_correct;
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, answer_a_correct, answer_b_correct, answer_c_correct, answer_d_correct, answer_e_correct, answer_f_correct);
    }
